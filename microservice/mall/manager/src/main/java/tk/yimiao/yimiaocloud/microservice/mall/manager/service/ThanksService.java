...
import tk.yimiao.yimiaocloud.microservice.mall.base.mapper.TbThanksMapper;
...
public class ThanksService {
    ...
    public DataTablesResult getThanksList() {
        ...
        if (list == null) {
            throw new BusinessException("获取捐赠列表失败");
        }
    ...
    public Long countThanks() {
        ...
        if (result == null) {
            throw new BusinessException("统计捐赠数目失败");
        }
        return result;
    }
    ...
    public int addThanks(TbThanks tbThanks) {
        ...
        if (tbThanksMapper.insert(tbThanks) != 1) {
            throw new BusinessException("添加捐赠失败");
        }
        return 1;
    }
    ...
    public int updateThanks(TbThanks tbThanks) {
        ...
        if (tbThanksMapper.updateByPrimaryKey(tbThanks) != 1) {
            throw new BusinessException("更新捐赠失败");
        }
        return 1;
    }
    ...
    public int deleteThanks(int id) {
        ...
        if (tbThanksMapper.deleteByPrimaryKey(id) != 1) {
            throw new BusinessException("删除捐赠失败");
        }
        return 1;
    }
    ...
    public TbThanks getThankById(int id) {
        ...
        if (tbThanks == null) {
            throw new BusinessException("获取捐赠数据失败");
        }
        return tbThanks;
    }
}
