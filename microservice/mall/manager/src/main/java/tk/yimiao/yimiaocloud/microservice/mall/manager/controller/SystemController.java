...
import tk.yimiao.yimiaocloud.common.util.IPInfoUtil;
...
import tk.yimiao.yimiaocloud.microservice.mall.base.pojo.TbShiroFilter;
import tk.yimiao.yimiaocloud.microservice.mall.base.pojo.TbUser;
import tk.yimiao.yimiaocloud.microservice.mall.manager.service.SystemService;
...
public class SystemController {
    ...
    public DataTablesResult getShiroList(TbUser tbUser) {
    ...
    public Result<Object> addShiro(TbShiroFilter tbShiroFilter) {
    ...
    public Result<Object> updateShiro(TbShiroFilter tbShiroFilter) {
    ...
    public Result<Object> updateBase(TbBase tbBase) {
