...
import tk.yimiao.yimiaocloud.microservice.mall.base.dto.RoleDto;
import tk.yimiao.yimiaocloud.microservice.mall.base.mapper.TbPermissionMapper;
import tk.yimiao.yimiaocloud.microservice.mall.base.mapper.TbRoleMapper;
import tk.yimiao.yimiaocloud.microservice.mall.base.mapper.TbRolePermMapper;
...
public class UserService {
    ...
    public TbUser getUserByUsername(String username) {
        ...
        try {
            ...
            throw new BusinessException("通过ID获取用户信息失败");
        }
        if (!list.isEmpty()) {
            return list.get(0);
        }
    ...
    public DataTablesResult getRoleList() {
        ...
        if (list1 == null) {
            throw new BusinessException("获取角色列表失败");
        }
    ...
    public List<TbRole> getAllRoles() {
        ...
        if (list == null) {
            throw new BusinessException("获取所有角色列表失败");
        }
        return list;
    }
        ...
        if (tbRole.getRoles() != null) {
            ...
            for (int i = 0; i < tbRole.getRoles().length; i++) {
                ...
                if (tbRolePermMapper.insert(tbRolePerm) != 1) {
                    throw new BusinessException("添加角色-权限失败");
                }
            }
        }
        return 1;
    ...
    public TbRole getRoleByRoleName(String roleName) {
        ...
        try {
            ...
            throw new BusinessException("通过角色名获取角色失败");
        }
        if (!list.isEmpty()) {
            return list.get(0);
        }
    ...
    public boolean getRoleByEditName(int id, String roleName) {
        ...
        TbRole newRole = null;
        if (tbRole == null) {
            throw new BusinessException("通过ID获取角色失败");
        }
    ...
    public int updateRole(TbRole tbRole) {
        ...
        if (tbRole.getRoles() != null) {
            ...
            for (int i = 0; i < tbRole.getRoles().length; i++) {
                ...
                if (tbRolePermMapper.insert(tbRolePerm) != 1) {
                    throw new BusinessException("编辑角色-权限失败");
                }
            }
        } else {
            TbRolePermExample example = new TbRolePermExample();
    ...
    public DataTablesResult getPermissionList() {
        ...
        if (list == null) {
            throw new BusinessException("获取权限列表失败");
        }
    ...
    public TbUser getUserById(Long id) {
        ...
        if (tbUser == null) {
            throw new BusinessException("通过ID获取用户失败");
        }
        tbUser.setPassword("");
        return tbUser;
    }
    ...
    public Long countUser() {
        ...
        if (result == null) {
            throw new BusinessException("统计用户数失败");
        }
        return result;
    }
}
