...
import tk.yimiao.yimiaocloud.common.model.IpInfo;
import tk.yimiao.yimiaocloud.common.model.IpWeatherResult;
...
public class IPInfoUtil {
    ...
    public static String getIpCity(String ip) {
        if (null != ip) {
            ...
            String result = "未知";
            try {
                IpWeatherResult weather = JSON.parseObject(json, IpWeatherResult.class);
