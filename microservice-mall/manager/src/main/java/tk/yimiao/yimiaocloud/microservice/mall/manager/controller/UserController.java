...
import tk.yimiao.yimiaocloud.common.annotation.SystemControllerLog;
...
import tk.yimiao.yimiaocloud.microservice.mall.base.pojo.TbRole;
import tk.yimiao.yimiaocloud.microservice.mall.base.pojo.TbUser;
import tk.yimiao.yimiaocloud.microservice.mall.manager.service.UserService;
...
public class UserController {
    ...
    public Result<Object> login(String username,
                                String password,
                                String challenge,
                                String validate,
                                String seccode,
    ...
    public Result<Object> addRole(TbRole tbRole) {
    ...
    public Result<Object> updateRole(TbRole tbRole) {
    ...
    public Result<Object> addPermission(TbPermission tbPermission) {
    ...
    public Result<Object> updatePermission(TbPermission tbPermission) {
    ...
    public Result<Object> addUser(TbUser tbUser) {
    ...
    public Result<Object> updateUser(TbUser tbUser) {
